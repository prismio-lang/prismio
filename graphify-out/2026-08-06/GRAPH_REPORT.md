...
## Corpus Check
- 61 files · ~154,272 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1627 nodes · 2839 edges · 129 communities (106 shown, 23 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 213 edges (avg confidence: 0.82)
...
Cohesion: 0.06
Nodes (77): Contributor Covenant Code of Conduct, Conventional Commits convention, Prismio Project Structure (src/ layout), Claim: no dedicated semantic analysis pass (planned), Test naming convention (test_<NN>_<description>.psm), POST_INSTALL.txt (install success message), Documented Compiler Pipeline (README architecture diagram), Contributor Covenant (README reference) (+69 more)

### Community 2 - "aif_key_var"
Cohesion: 0.29
Nodes (7): aif_key_var(), aif_var_note_scope(), aif_var_scope(), escape_join(), raise_escape(), scope_lca(), var_scope_grow()
...
Cohesion: 0.20
Nodes (27): FILE, build_from_toolchain_sources(), compile_ir_to_object(), compiler_bootstrap_executable(), compiler_build_executable(), compiler_default_exe_path(), compiler_prepare_output_path(), compiler_run_executable() (+19 more)

### Community 5 - "lang_runtime.c"
Cohesion: 0.07
Nodes (17): Array, aif_live_hash(), aif_verify_alloc(), aif_verify_release(), array_free(), array_get(), array_len(), array_new() (+9 more)
...
Cohesion: 0.07
Nodes (36): extern fn ir_add, extern fn ir_append, extern fn ir_append_line, extern fn ir_br_numbered, extern fn ir_clear_returned, extern fn ir_cond_br_numbered, extern fn ir_function_begin, extern fn ir_function_body_start (+28 more)

### Community 11 - "extern fn ptr_to_node"
Cohesion: 0.09
Nodes (37): extern fn ptr_to_node, extern fn ir_alloca, extern fn ir_blank_line, extern fn ir_clear_var_types, extern fn ir_declare_function_begin, extern fn ir_declare_function_end, extern fn ir_declare_function_param, extern fn ir_global_string (+29 more)

### Community 12 - "extern fn str_equals"
Cohesion: 0.15
Nodes (21): fn fn_key(name) -> String, fn ir_ptr_int_type() -> String, fn map_type(t) -> String, fn struct_type_key(name) -> String, fn get_operator_precedence(t) -> Int, fn sema_find_function(module, name) -> ASTNode, fn sema_fn_key(name) -> String, fn sema_function_symbol(module, fn_node) -> String (+13 more)
...
Cohesion: 0.18
Nodes (30): fn struct_type_name(t) -> String, fn sema_annotation_type(module, tn) -> TypeInfo, fn type_array, fn type_bool() -> TypeInfo, fn type_char() -> TypeInfo, fn type_enum, fn type_float() -> TypeInfo, fn type_from_annotation (+22 more)
...
Cohesion: 0.07
Nodes (78): LLVMBasicBlockRef, LLVMTypeRef, LLVMValueRef, NamedValue, strcmp(), backend_fail(), block_done(), block_for() (+70 more)
...
### Community 34 - "strlen"
Cohesion: 0.21
Nodes (13): ir_clear_local_var_types(), str_char_at(), str_concat(), str_contains(), str_ends_with(), str_index_of(), str_length(), str_replace() (+5 more)
...
### Community 37 - "xmalloc"
Cohesion: 0.22
Nodes (10): aif_frees_at_scope_node(), aif_oom(), aif_site_note_node(), aif_tier_at_node(), aif_tier_of(), fits_on_stack(), node_hash(), site_is_move_only() (+2 more)
...
### Community 46 - "malloc"
Cohesion: 0.20
Nodes (11): compiler_installed_runtime_hash(), run_command_path(), diag_add_file(), diag_strdup(), list_new(), list_push(), malloc(), str_from_char() (+3 more)

### Community 61 - "program_support.c"
Cohesion: 0.16
Nodes (11): accept_if_exists(), find_in_lib_dir(), find_toolchain_library(), str_clone(), strcpy(), executable_directory(), execute_command(), file_exists() (+3 more)
...
Cohesion: 0.17
Nodes (12): aif_extern_contract(), aif_fn_name(), aif_fn_symbol(), aif_key_field(), aif_key_param(), aif_key_ret(), aif_nominal_name(), aif_order_symbol() (+4 more)
...
Cohesion: 0.17
Nodes (17): aif_enum_new(), aif_extern_contract_set(), aif_fn_lookup(), aif_fn_new(), aif_intern(), aif_order_add(), aif_scope_new(), aif_site_new() (+9 more)
...
Cohesion: 0.22
Nodes (10): aif_is_enum(), aif_is_struct(), aif_struct_nfields(), aif_struct_size(), aif_type_acyclic(), aif_type_edge(), nominal_find(), nominal_find_id() (+2 more)
...
### Community 128 - "strncpy"
Cohesion: 0.22
Nodes (9): str_split(), str_split_free(), str_substring(), str_trim(), strncpy(), ir_set_alloc_function(), ir_set_free_function(), ir_set_pointer_int_type() (+1 more)
...
- **Why does `aif_intern()` connect `aif_intern` to `strlen`, `aif_key_var`, `lang_runtime.c`, `xmalloc`, `aif_str`, `nominal_find`, `aif_support.c`, `llvm-api-backend.c`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `strlen()` connect `strlen` to `strncpy`, `ir_symbols.c`, `build_driver.c`, `lang_runtime.c`, `malloc`, `llvm-api-backend.c`, `aif_intern`, `program_support.c`?**

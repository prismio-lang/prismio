...
## Corpus Check
- 70 files · ~215,719 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1615 nodes · 2732 edges · 117 communities (111 shown, 6 thin omitted)
...
### Community 0 - "program_support.c"
Cohesion: 0.27
Nodes (5): str_clone(), strcpy(), executable_directory(), get_directory(), prismio_executable_directory()
...
### Community 4 - "free"
Cohesion: 0.18
Nodes (25): FILE, accept_if_exists(), build_from_toolchain_sources(), compiler_bootstrap_executable(), compiler_build_executable(), compiler_prepare_output_path(), compiler_runtime_source_hash(), compiler_temp_ir_path() (+17 more)

### Community 5 - "lang_runtime.c"
Cohesion: 0.04
Nodes (31): ArenaChunk, aif_live_hash(), aif_verify_alloc(), aif_verify_arm(), aif_verify_release(), arena_alloc(), arena_chunk_new(), arena_push() (+23 more)
...
Cohesion: 0.05
Nodes (98): LLVMBasicBlockRef, LLVMTypeRef, LLVMValueRef, NamedValue, strncpy(), backend_fail(), block_done(), block_for() (+90 more)
...
### Community 34 - "malloc"
Cohesion: 0.19
Nodes (23): compile_ir_to_object(), compiler_default_exe_path(), compiler_installed_runtime_hash(), compiler_run_executable(), link_against_runtime_library(), path_without_extension(), run_build_command(), run_command_path() (+15 more)
...
Cohesion: 0.14
Nodes (24): aif_arena_at_node(), aif_cycle_at_node(), aif_elem_owner_at_node(), aif_frees_at_scope_node(), aif_note_call_result(), aif_owns_call_result_at_node(), aif_rc_at_node(), aif_region_name_at_site() (+16 more)
...
### Community 49 - "strcmp"
Cohesion: 0.29
Nodes (7): record_cmp(), diag_add_file(), str_compare(), str_ends_with(), str_equals(), strcmp(), compare_names()

### Community 50 - "str_replace"
Cohesion: 0.29
Nodes (7): ir_clear_local_var_types(), str_contains(), str_index_of(), str_replace(), str_starts_with(), strncmp(), strstr()
...
Cohesion: 0.11
Nodes (18): 0. HEAD did not compile, and that is not in any previous handoff, 1. The 79 T3 sites were a stale reporting default, not a residue, 2. What ownership contexts would buy, measured, 3. The benchmark, and it falsifies a claim the corpus makes about itself, Current state, File roles, Five rules learned the hard way, Four things to carry forward (+10 more)

### Community 71 - "aif_str"
Cohesion: 0.25
Nodes (8): aif_fn_name(), aif_fn_symbol(), aif_layout_field(), aif_nominal_name(), aif_order_symbol(), aif_scope_region(), aif_site_type(), aif_str()
...
Cohesion: 0.16
Nodes (25): Bits, Deriv, IntVec, aif_argv_push(), aif_reset(), aif_solve(), aif_widen(), bits_clear() (+17 more)
...
Cohesion: 0.09
Nodes (35): Nominal, aif_compute_type_acyclic(), aif_elem_type_at_node(), aif_field_access(), aif_field_is_counted(), aif_field_is_cyclic(), aif_field_release(), aif_is_enum() (+27 more)
...
## Knowledge Gaps
- **502 isolated node(s):** `1.1 Pipeline trace: `prismio build file.psm` → executable`, `1.2 How runtime libraries are included: embedded, external, or both?`, `1.3 Every file and function responsible`, `2.1 What happens when the compiler compiles itself (`prismio build src/main.psm`)?`, `2.2 Duplicate runtime linkage — two separate risks, at two separate layers` (+497 more)
...
- **Why does `strcmp()` connect `strcmp` to `malloc`, `free`, `lang_runtime.c`, `ir_intern`, `llvm-api-backend.c`, `aif_intern`?**
  _High betweenness centrality (0.105) - this node is a cross-community bridge._
- **Why does `aif_intern()` connect `aif_intern` to `malloc`, `aif_tier_of`, `nominal_find`, `aif_support.c`, `strcmp`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `malloc()` connect `malloc` to `program_support.c`, `g6_bench.c`, `free`, `aif_tier_of`, `lang_runtime.c`, `g2_bench_arena.c`, `add_binding`, `cyc_hdr`, `g2_bench.c`, `llvm-api-backend.c`?**

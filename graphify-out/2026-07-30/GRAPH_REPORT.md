# Graph Report - self  (2026-07-29)

## Corpus Check
- 13 files · ~21,750 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 796 nodes · 1601 edges · 73 communities (49 shown, 24 thin omitted)
...
Cohesion: 0.07
Nodes (85): extern fn ir_clear_borrowed, extern fn ir_clear_moved, extern fn ir_has_var_type, extern fn ir_is_borrowed, extern fn ir_is_moved, extern fn ir_mark_borrowed, extern fn ir_mark_moved, extern fn ir_set_var_type (+77 more)

### Community 1 - "AST & Parser Core"
Cohesion: 0.13
Nodes (62): fn create_node(kind) -> ASTNode, extern fn node_to_ptr, extern fn ptr_to_node, extern fn ir_global_string, fn collect_strings_block(block), fn collect_strings_expr(expr), fn collect_strings_function(func), fn collect_strings_stmt(stmt) (+54 more)
...
Cohesion: 0.07
Nodes (16): ir_close_file(), ir_flush(), ir_icmp(), ir_icmp_eq(), ir_icmp_ne(), ir_icmp_sge(), ir_icmp_sgt(), ir_icmp_sle() (+8 more)

### Community 4 - "LLVM IR Codegen Primitives (C)"
Cohesion: 0.09
Nodes (33): ir_and(), ir_append_line(), ir_bitcast(), ir_blank_line(), ir_br(), ir_br_numbered(), ir_cond_br(), ir_cond_br_numbered() (+25 more)

### Community 5 - "Runtime Array Operations (C)"
Cohesion: 0.08
Nodes (17): Array, array_free(), array_get(), array_len(), array_new(), array_push(), int_to_str(), int_to_str_buffer() (+9 more)
...
Cohesion: 0.15
Nodes (26): FILE, command_quote_arg(), compiler_build_executable(), compiler_executable_directory(), compiler_prepare_output_path(), compiler_run_executable(), compiler_temp_ir_path(), compiler_temp_obj_path() (+18 more)
...
Cohesion: 0.08
Nodes (29): extern fn ir_add, extern fn ir_br_numbered, extern fn ir_clear_local_var_types, extern fn ir_clear_returned, extern fn ir_cond_br_numbered, extern fn ir_function_begin, extern fn ir_function_body_start, extern fn ir_function_end (+21 more)

### Community 11 - "IR Bridge: Function Declaration FFI"
Cohesion: 0.10
Nodes (28): extern fn ir_blank_line, extern fn ir_clear_var_types, extern fn ir_declare_function_begin, extern fn ir_declare_function_end, extern fn ir_declare_function_param, extern fn ir_global_var, extern fn ir_is_struct_type_name, extern fn ir_module_end (+20 more)

### Community 12 - "Runtime Path & String Helpers (C)"
Cohesion: 0.29
Nodes (10): str_char_at(), str_clone(), str_concat(), str_length(), str_replace(), strcat(), strcpy(), strlen() (+2 more)
...
Cohesion: 0.13
Nodes (19): compiler_default_exe_path(), path_without_extension(), read_file(), list_new(), list_push(), malloc(), str_split(), str_split_free() (+11 more)

### Community 22 - "String Comparison Runtime (C)"
Cohesion: 0.11
Nodes (18): str_compare(), str_ends_with(), str_equals(), strcmp(), ir_call_end(), ir_clear_local_var_types(), ir_get_enum_variant(), ir_get_struct_field_index() (+10 more)
...
Cohesion: 0.24
Nodes (11): extern fn ir_alloca, extern fn ir_get_enum_variant, extern fn ir_get_struct_field_type, extern fn ir_get_var_type, fn get_expr_type(expr) -> String, fn get_variable_decl_type(stmt) -> String, fn is_struct_type_key(t) -> Bool, fn llvm_type_name(t) -> String (+3 more)
...
### Community 70 - "Documented Compiler Pipeline (README architecture diagram)"
Cohesion: 0.40
...
Cohesion: 0.40
Nodes (5): extern fn ir_append, extern fn ir_append_line, extern fn ir_get_struct_field_index, extern fn ir_register_struct_field, fn generate_struct_decl(struct_node)
...
- **What is the exact relationship between `Claim: no semantic analysis pass between parsing and IR gen (planned)` and `fn analyze_module(module)`?**
  _Edge tagged AMBIGUOUS (relation: references) - confidence is low._
- **Why does `extern fn ptr_to_node` connect `AST & Parser Core` to `Type System & Semantic Analysis`, `IR Bridge FFI Declarations`, `fn generate_struct_decl(struct_node)`, `IR Bridge: Codegen Emission FFI`, `IR Bridge: Function Declaration FFI`, `IR: Globals & Enum Variants`, `IR: Struct/Enum Type Queries`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `fn generate_expression(expr) -> String` connect `IR Bridge FFI Declarations` to `Type System & Semantic Analysis`, `AST & Parser Core`, `fn generate_struct_decl(struct_node)`, `IR Bridge: Codegen Emission FFI`, `IR Bridge: Function Declaration FFI`, `IR: Struct/Enum Type Queries`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `extern fn str_equals` connect `Type System & Semantic Analysis` to `AST & Parser Core`, `IR Type Mapping Helpers`, `LLVM Output File I/O (C)`, `IR Bridge: Function Declaration FFI`, `Lexer & String Utilities`, `IR: Globals & Enum Variants`, `IR: Struct/Enum Type Queries`?**

...
"    { \"prismio_platform.h\", 0, NULL },\n"
"    { \"prismio_runtime.h\",  0, NULL },\n"
"    { \"lang_runtime.c\",     1, \"lang_runtime\" },\n"
"    { \"program_support.c\",  1, \"program_support\" },\n"
"    { \"build_driver.c\",     1, \"build_driver\" },\n"
"    { \"llvm-bridge.c\",      1, \"bridge\" },\n"
"};\n"
"\n"
...
"    }\n"
"\n"
"    // llc turns the generated IR into an object; clang compiles each toolchain\n"
"    // source and links the lot.\n"
...
"    }\n"
"    command_len += (int)(strlen(q_ir) + strlen(q_exe) + strlen(q_program_obj));\n"

...
static const char prismio_embedded_aif_containers_h[] =
...
static const char prismio_embedded_aif_containers_c[] =
...
"// `str_clone`, the release paths, every `ir_call_arg(\"ptr\", \342\200\246)` codegen writes by\n"
...
"// `ir_call_arg(\"ptr\", \342\200\246)` already coerces on its way through `resolve_value`;\n"
